...
function Upload() {
  ...
  return (
    <div className=" absolute inset-0 h-screen font-['Rubik'] bg-[#012a4a]">
      <Nav />
      <div className=" flex flex-col relative h-[500px] items-center w-screen ">
        <div className="bg-white h-[300px] w-screen "></div>
        <div className=" absolute bottom-0 bg-[#ffff] p-2 h-fit w-fit rounded-lg shadow-lg ">
